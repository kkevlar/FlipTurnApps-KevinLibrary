...
public class KJCheckBoxPackage extends JPanel
{
	...
	public KJCheckBoxPackage (int number)
	{
		super();
		setUp(number);
	}
	public KJCheckBoxPackage(Color[] colors)
	{
		super();
		setUp(colors.length);
	...
	public JCheckBox getBox(int number)
	{
		return boxes[number];
	}
